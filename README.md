...
+ [Cloud Client Architecture](hCloud-Client-Architecture/README.md) is a good place to go next.  It starts at the top of the application tree - with a discussion of current client-side application patterns that faciliatate cloud-native development.
...
+ [Container Architecture](container-architecture/README.md) contains the patterns around building a devops pipeline and managing the containers that your microservices will be deployed into.
