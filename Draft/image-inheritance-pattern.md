...
**Share layers between Docker images but don't go overboard with very deep hierarchies; an OS base layer, a runtime layer, and an application layer are often enough.**
